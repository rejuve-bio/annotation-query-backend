...
class CypherQueryGenerator(QueryGeneratorInterface):
    ...
    def parse_id(self, request):
        ...
        return request
    #############################################
    def graph_function(match_result, all_properties):
        nodes = []
        edges = []
        node_dict = {}
        node_to_dict = {}
    ...
    def count_node_and_edges_function(node_and_edge_count):
        node_count = 0
        edge_count = 0
    ...
    #     match_result = results[0]
    #     node_and_edge_count = results[1] if len(results) > 1 else []
    #     count_by_label = results[2] if len(results) > 2 else []

    #     # Extract nodes and edges
    #     nodes, edges, node_to_dict, edge_to_dict = graph_function(match_result, all_properties)

    #     # Compute total node and edge counts
    #     node_count, edge_count = count_node_and_edges_function(node_and_edge_count)

    #     # Compute node and edge counts by label
    #     node_count_by_label, edge_count_by_label = count_by_label_function(count_by_label)
